...
</style><div class="container"><div class="row-fluid  wall statis"><article class="span3">                累计融资金额

                <span class="amount"><?php echo (number_format($accumulate["sum"],2,',',',')); ?><span class="decimals">元</span></span></article><article class="span3">                预期收益
                <span class="amount"><?php echo (number_format($accumulate["benefit"],2,',',',')); ?><span class="decimals">元</span></span></article><article class="span3">                综合年化收益率
                <span class="amount"><?php echo (number_format($accumulate["avg"],2,'.',',')); ?><span class="decimals">%</span></span></article><article class="span3">                注册人数
                 <span class="amount"><?php echo ($accumulate["enrollment"]); ?><span class="decimals">人</span></span></article></div><div class="row-fluid"><div class="span9 separate"><!--借款标 state--><?php if(is_array($borrow)): $i = 0; $__LIST__ = $borrow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- 普通标 state--><div class="project-summary wall" style="position: relative;"><?php if($v["state"] == 0): elseif($v["state"] == 4): ?><div class="bid-completed-failure"></div><?php else: ?><div class="bid-completed-stamp"></div><?php endif; ?><div class="row-fluid"><div class="span8 "><div style="min-height: 75px;"><h4  class="index_h4"><a href="__ROOT__/Loan/invest/<?php echo ($v["id"]); ?>.html" data-rel="tooltip" title="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></a>&nbsp;&nbsp;

                    </h4><p class="project-tags"><?php if($v["state"] == 0): ?><span class="label label-success">投标中</span><?php else: ?><span class="label"><?php echo ($v["state_name"]); ?></span><?php endif; if(($v["stick"]) == "1"): ?><span class="tag" data-rel="tooltip" title="推荐"><i class="icon icon-darkgray icon-lightbulb"></i>推荐</span><?php endif; if(($v["code"]) == "1"): ?><span class="tag" data-rel="tooltip" title="需要密码"><i class="icon icon-darkgray icon-locked"></i>密码</span><?php endif; ?><span class="label label-warning" title="企业信用"><?php echo ($v["privacy"]); ?></span></p></div><div class="row-fluid"><div class="span12"><div class="pull-left" style="margin-right: 10px;"><?php if($v["state"] == 0): ?><a class="btn btn-large btn-primary btn-details" href="__ROOT__/Loan/invest/<?php echo ($v["id"]); ?>.html">我要投资</a><?php else: ?><a class="btn btn-large btn-details" ><?php echo ($v["state_name"]); ?></a><?php endif; ?></div><div class="pull-left"><div class="project-progress"><div class="progress progress-striped active"><div class="bar" style="width: <?php echo ($v["ratio"]); ?>%;"></div></div></div></div></div></div></div><div class="span4"><ul class="project-summary-items"><li><span class="title">融资金额</span><?php echo (number_format($v["money"],2,'.',',')); ?> 元</li><li><span class="title">年化收益</span><span class="important data-tips"><?php echo ($v["rates"]); ?>%
                    	</span></li><li><span class="title">融资期限</span><span class="data-tips"><?php echo ($v["deadlines"]); ?></span></li><li></li></ul></div></div></div><!-- 普通标 end--><?php endforeach; endif; else: echo "" ;endif; ?><!--借款标 end--><p style="text-align: center"><a href="__ROOT__/Loan.html" class="btn btn-warning btn-large">查看更多项目</a></p></div><div class="span3 post-thumbnail"><section><a href="__ROOT__/Site/listTpl/id/28.html" class="more">更多</a><h3>名词解释</h3><ul><?php if(is_array($explanation)): $i = 0; $__LIST__ = $explanation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__ROOT__/Site/article/id/<?php echo ($vo["id"]); ?>.html" target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></section><hr><section><a href="__ROOT__/Site/listTpl/id/32.html" class="more">更多</a><h3>平台公告</h3><ul><?php if(is_array($new)): $i = 0; $__LIST__ = $new;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__ROOT__/Site/article/id/<?php echo ($vo["id"]); ?>.html" target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></section><hr><section><a href="__ROOT__/Site/listTpl/id/31.html" class="more">更多</a><h3>帮助中心</h3><ul><?php if(is_array($help)): $i = 0; $__LIST__ = $help;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__ROOT__/Site/article/id/<?php echo ($vo["id"]); ?>.html" target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></section><hr></div></div></div><!-- container end --><!--底部  start--></div><!-- Footer
...
</script></body></html><script src="__PUBLIC__/js/jquery.kinMaxShow-1.1.min.js"></script>